#!/usr/bin/env python3
"""
Robust financial data extraction with better filtering for numeric values.
"""
...
def extract_robust_financials(conn):
    """Extract financial data with robust filtering for numeric values."""
    cursor = conn.cursor()
...
def generate_robust_report(financial_data, output_file=None):
    """Generate a comprehensive financial report with robust data."""
    ...
    print("=" * 100)
    print("ROBUST FINANCIAL ANALYSIS - MAIN TOTALS ONLY")
    print("=" * 100)
    ...
    if output_file:
        ...
        print(f"\nRobust data saved to: {output_file}")
...
def main():
    ...
    try:
        print("Extracting robust financial data...")
        financial_data = extract_robust_financials(conn)
        ...
        output_file = "robust_financial_analysis.csv"
        validated_df = generate_robust_report(financial_data, output_file)
